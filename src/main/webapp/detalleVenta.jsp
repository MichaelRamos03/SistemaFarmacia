<%-- 
    ...
    Created on : 9 jun 2025, 11:21:19 p. m.
    Author     : Gaby Laínez
--%>
                                ...
                                <div class="col-md-6 col-xl-6">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span id="detalle_registradas" class="counter text-blue-grey">0</span>
                                            Registro Detalles de venta                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-6" id="registrar_Detalle" style="cursor: pointer;">
                                    <div class="mini-stat clearfix bg-white">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Registro nueva Venta<br>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label  id="labelDetalle" >Id Detalle</label>
                                            <input type="text" autocomplete="off"                                                  
                                                   name="idDetalle_venta" id="idDetalle_venta"
                                                   val=""
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select  id="idMedicamento"  name="idMedicamento" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                   ...
                                                   data-parsley-min="1"
                                                   data-parsley-required-message="Debe ingresar la cantidad"
                                                   data-parsley-type-message="Ingrese un número válido"
                                                   data-parsley-min-message="La cantidad mínima es 1"/> 
