<%-- 
    ...
    Created on : 9 jun 2025, 8:59:54 p. m.
    Author     : Gaby Laínez
--%>
                                ...
                                <div class="col-md-6 col-xl-6">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span id="venta_registradas" class="counter text-blue-grey">0</span>
                                            Registro ventas
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-6" id="registrar_Venta" style="cursor: pointer;">
                                    <div class="mini-stat clearfix bg-white">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" 
                                                   ...
                                                   name="fechaVenta" id="fechaVenta" required/>
