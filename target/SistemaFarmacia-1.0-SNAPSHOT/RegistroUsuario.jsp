...
<html>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                            ...
                            <div class="row">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-3 col-xl-3">
                                        <div class="mini-stat clearfix bg-white" id="registrar_usuario" style="cursor: pointer;">
                                ...
                                <div class="row mt-3" id="contenedor_inactivas" style="display:none;">
                                    <div class="col-12">
                                        <div class="card border border-danger">
                                            ...
                                            <div class="card-body" id="lista_usuarios_inactivas">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="md_registrar_usuario" role="dialog"  aria-hidden="true">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Registro nuevo Usuario<br>
                        ...
                        <div class="modal-body">
                            <form name="formulario_usuario" id="formulario_usuario" data-parsley-validate>
                                <input type="hidden" id="opcion" name="opcion"
                                       value="insertar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label  id="labelIdUsuario" >id Usuario</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Rol</label>
                                            <select  id="nombreRol"  name="nombreRol" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" 
                                                   data-parsley-excluded="true"
                                                   name="contrasenia" id="contrasenia" required data-parsley-minlength="6"
                                                   data-parsley-error-message="Contraseña requerida (mínimo 6 caracteres)"/>
                                            <p class="error hidden" id="error">Campo requerido</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
